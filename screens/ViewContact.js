      ...
      <ScrollView style={styles.container}>
        ...
        <Card style={styles.actionContainer}>
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="message" size={50} color="#01CBC6" />
            </TouchableOpacity>
          </CardItem>
          <CardItem style={styles.actionButton} bordered>
            <TouchableOpacity
            ...
            >
              <Entypo name="phone" size={50} color="#01CBC6" />
            </TouchableOpacity>
          </CardItem>
        </Card>
        ...
        <Card style={styles.actionContainer}>
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="edit" size={30} color="#01CBC6" />
          ...
          <CardItem style={styles.actionButton} bordered>
            ...
            >
              <Entypo name="trash" size={30} color="#01CBC6" />
